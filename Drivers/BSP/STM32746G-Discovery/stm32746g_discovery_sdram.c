...
void BSP_SDRAM_Initialization_sequence(uint32_t RefreshCount)
{
  ...
  printf("[SDRAM_Seq] Step 1: Clock Enable...\r\n");
  ...
  printf("[SDRAM_Seq] Step 2: Delay...\r\n");
  /* Step 2: Insert 100 us minimum delay */ 
  /* Inserted delay is equal to 1 ms due to systick time base unit (ms) */
  HAL_Delay(1);
    
  printf("[SDRAM_Seq] Step 3: PALL...\r\n");
  ...
  printf("[SDRAM_Seq] Step 4: AutoRefresh...\r\n");
  ...
  printf("[SDRAM_Seq] Step 5: LoadMode...\r\n");
  ...
  printf("[SDRAM_Seq] Step 6: RefreshRate...\r\n");
